 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Application_Form_EmailAddress extends Zend_Validate_Abstract
{
    ...
    protected $_messageTemplates = array(
        ...
        self::INVALID_FORMAT     => "'%value%' n'est pas une adresse email correcte ! exemple : local-part@hostname",
